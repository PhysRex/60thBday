...
# 60thBday git init git add README.md git commit -m first commit git remote add origin https://github.com/PhysRex/60thBday.git git push -u origin master
# 60thBday git init git add README.md
